...
#[derive(Debug)]
pub struct OktaSDKProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OktaSDKProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OktaSDK processing");
    
    let mut processor = OktaSDKProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OktaSDKProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OktaSDKProcessor::new(false);
